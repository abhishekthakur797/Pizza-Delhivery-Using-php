	...
	<table border="1" cellpadding="10">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="delete.php?id=<?php echo $row[0] ?>" onclick="return confirm('Are you sure you wish to delete <?php echo $row[1] ?> record ?')"> DELETE </a>
				</td>
				<td>
					<a href="update.php?id=<?php echo $row[0] ?>" onclick="return confirm('Are you sure you wish to update <?php echo $row[1] ?> record ?')"> UPDATE </a>
				</td>
			</tr>
		<?php } ?>
		</tbody>
